...
import { PlasmicCall } from "../../components/plasmic/babarkat/PlasmicCall";
...
function Call() {
  ...
  // fetch data.
  //
  // Props you can pass into PlasmicCall are:
  // 1. Variants you want to activate,
  // 2. Contents for slots you want to fill,
  // 3. Overrides for any named node in the component to attach behavior and data,
  // 4. Props to set on the root node.
  //
  // By default, PlasmicCall is wrapped by your project's global
