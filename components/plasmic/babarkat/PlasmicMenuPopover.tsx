...
import sty from "./PlasmicMenuPopover.module.css"; // plasmic-import: QXgTY-SNMiWy/css
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__sSAh)}
                    value={"item1"}
                  />
                  ...
                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__rToZ)}
                    label={"Item 3"}
                    value={"item3"}
                  />
