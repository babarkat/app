...
import Label from "../../Label"; // plasmic-import: JIBGSgatSww7/component
...
import SliderThumb from "../../SliderThumb"; // plasmic-import: cTlccEttIiby/component
import Description from "../../Description"; // plasmic-import: Ap5u0jRncsyz/component
...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: F8RXUtgDpowY/css
  ...
  return (
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <div className={classNames("all", sty.freeBox__ihlRw)}>
          {$props.showLabel ? (
            <Label
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <div
                    className={classNames("all", "__wab_text", sty.text__fuzmS)}
                  >
                    {"Label"}
                  </div>
                ),
      ...
      <div className={classNames("all", sty.freeBox__uhnIx)}>
        <div
