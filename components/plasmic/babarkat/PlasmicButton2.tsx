...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: N0cXbq2ZnpaG/css
...
function PlasmicButton2__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames("all", sty.freeBox__xRDiC, {
          [sty.freeBoxcolor_neutral__xRDiCikfRz]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__xRDiCb2OrDUKgA]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxroundedFull__xRDiCmvnvJ]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__xRDiC797Av]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__xRDiCubw8R]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__xRDiC7I18Y]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__xRDiCsMxMe]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__xRDiCdUKgA]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames("all", sty.freeBox__hAeS, {
            [sty.freeBoxcolor_neutral__hAeSikfRz]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__hAeScKkoy]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__hAeS797Av]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__hAeS7I18Y]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__hAeSsMxMe]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__hAeSdUKgA]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__hAeS69XocIkfRz]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__jtOt)}
                role={"img"}
              />
            ),
        ...
        {renderPlasmicSlot({
          defaultContents: (
            <div className={classNames("all", "__wab_text", sty.text__ailoJ)}>
              {"Text"}
            </div>
          ),
          value: args.label,
        ...
        <div
          className={classNames("all", sty.freeBox__rydKz, {
            [sty.freeBoxiconEnd__rydKzo8772]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__rydKz797Av]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__rydKz7I18Y]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__rydKzSMxMe]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames("all", sty.svg___5XEa)}
                role={"img"}
              />
            ),
