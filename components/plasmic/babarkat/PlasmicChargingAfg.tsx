...
`;
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox__zHIi4, {
                      ...
                      [sty.freeBoxstepscharg_step3__zHIi4Q2TCe]: hasVariant(
                        $state,
                        "stepscharg",
                        "step3"
                      )
                ...
                >
                  ...
                  {(
                    ...
                    >
                      ...
                      <PlasmicImg__
                        alt={""}
                        className={classNames(sty.img___2L70D, {
                          [sty.imgstepscharg_step3___2L70Dq2TCe]: hasVariant(
                            $state,
                            "stepscharg",
                            "step3"
                          )
                          ...
                          className={classNames(
                            ...
                            sty.text___73BnS,
                            {
                              [sty.textstepscharg_step2___73BnS1Oc4H]:
                                hasVariant($state, "stepscharg", "step2"),
                              [sty.textstepscharg_step3___73BnSq2TCe]:
                                hasVariant($state, "stepscharg", "step3")
                            }
                          )}
                        >
                          ...
                          $state.amontAfg >= 50 && $state.amontAfg <= 1000
                            ? (() => {
                                const actionArgs = {
                                  ...
                                  operation: 0,
                                  value: $state.exchange2.tomanWithoutCommission
                                };
                                return (({
                                  variable,
                                  value,
              ...
              try {
                return {
                  data: [
                    ...
                    {
                      text: "توضیحات",
                      value: `${$state.operators2[$state.operatorselect].description} ${$state.operators2[$state.operatorselect].services[$state.typecharge].text} - ${$state.amontAfg.toLocaleString()} افغانی`
                    },
                    {
                      text: "تاریخ و زمان",
                      value: (() => {
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicChargingAfg__VariantsArgs, ReservedPropsType> &
