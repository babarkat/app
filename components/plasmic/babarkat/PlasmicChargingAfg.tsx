            ...
            services: [
              {
                type: "normal",
                text: "\u0645\u0639\u0645\u0648\u0644\u06cc",
                chargeAmounts: [30, 50, 100, 150, 200, 300, 500, 1000]
              }
            ]
          },
          {
                    ...
                    >
                      <div
                        className={classNames(
                          ...
                          sty.text___3Wpc,
                          {
                            [sty.textstepscharg_step2___3Wpc1Oc4H]: hasVariant(
                              $state,
                              "stepscharg",
                              "step2"
                            )
                  ...
                  {(
                    ...
                    <Button
                      ...
                      onClick={async event => {
                        ...
                        $steps["updateAmont"] =
                          $state.amontAfg >= 25 && $state.amontAfg <= 2500
                            ? (() => {
                                const actionArgs = {
                                  variable: {
                                    objRoot: $state,
                          ...
                          $state.amontAfg < 25 || $state.amontAfg > 2500
                            ? (() => {
                                const actionArgs = {
                                  args: [
                                    "error",
                                    "\u0645\u0628\u0644\u063a \u0628\u0627\u06cc\u062f \u0628\u06cc\u0646 25 \u062a\u0627 2500 \u0627\u0641\u063a\u0627\u0646\u06cc \u0628\u0627\u0634\u062f.",
                                    undefined,
                                    5
                                  ]
                                };
