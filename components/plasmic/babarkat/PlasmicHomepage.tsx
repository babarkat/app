        ...
        >
          <SideEffect
            ...
            onMount={async () => {
              ...
              $steps["runCode2"] =
                window.sessionStorage.getItem("cash") != null
                  ? (() => {
                      const actionArgs = {
                        customFunction: async () => {
                          return (() => {
                ...
                window.sessionStorage.getItem("cash") != null
                  ? (() => {
                      const actionArgs = {
                        variable: {
                          objRoot: $state,
                          variablePath: ["userbabarcat"]
                        },
                        operation: 0,
                        value: ($state.userbabarcat = JSON.parse(
          ...
          <section className={classNames(projectcss.all, sty.section__y9X3X)}>
            <div className={classNames(projectcss.all, sty.freeBox__c8Hj)}>
              ...
              {(() => {
                try {
                  return $state.userbabarcat == {} && $state.loading == false;
                } catch (e) {
                  if (
                    e instanceof TypeError ||
                    e?.plasmicType === "PlasmicUndefinedDataError"
                        ...
                        >
                          ...
                          <div
                            ...
                            onClick={async event => {
                              ...
                              if (
                                ...
                                typeof $steps["updateCallOpen"] === "object" &&
                          ...
                          <div
                            ...
                            onClick={async event => {
                              ...
                              $steps["goToBill"] = true
                                ? (() => {
                                    const actionArgs = { destination: `/Bill` };
                                    return (({ destination }) => {
                                      if (
                                        typeof destination === "string" &&
                                        destination.startsWith("#")
