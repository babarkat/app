...
import sty from "./PlasmicIncreaseInInventory.module.css"; // plasmic-import: oL3KAEkkwqXW/css
...
export type PlasmicIncreaseInInventory__VariantMembers = {
  stepscharg: "step2" | "step3" | "step1";
};
export type PlasmicIncreaseInInventory__VariantsArgs = {
  stepscharg?: SingleChoiceArg<"step2" | "step3" | "step1">;
};
type VariantPropType = keyof PlasmicIncreaseInInventory__VariantsArgs;
export const PlasmicIncreaseInInventory__VariantProps =
  new Array<VariantPropType>("stepscharg");

export type PlasmicIncreaseInInventory__ArgsType = {};
type ArgPropType = keyof PlasmicIncreaseInInventory__ArgsType;
export const PlasmicIncreaseInInventory__ArgProps = new Array<ArgPropType>();

export type PlasmicIncreaseInInventory__OverridesType = {
...
export interface DefaultIncreaseInInventoryProps {}
...
function PlasmicIncreaseInInventory__RenderFunc(props: {
  variants: PlasmicIncreaseInInventory__VariantsArgs;
  args: PlasmicIncreaseInInventory__ArgsType;
  overrides: PlasmicIncreaseInInventory__OverridesType;
  forNode?: string;
}) {
  ...
  const stateSpecs: Parameters<typeof useDollarState>[0] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        type: "private",
        variableType: "text",
        initFunc: ({ $props, $state, $queries, $q, $ctx }) => "bill_id"
      },
      {
        path: "idinput2.value",
        type: "private",
  ...
  return (
    <React.Fragment>
      ...
      >
        <section
          className={classNames("all", sty.section__wOte6, {
            [sty.sectionstepscharg_step1__wOte60Mzt0]: hasVariant(
              $state,
              "stepscharg",
              "step1"
            ),
            [sty.sectionstepscharg_step3__wOte6Tdash]: hasVariant(
              $state,
              "stepscharg",
              "step3"
            )
        ...
        >
          <div
            className={classNames("all", sty.freeBox__brgxS, {
              [sty.freeBoxstepscharg_step2__brgxSKuLy5]: hasVariant(
                $state,
                "stepscharg",
                "step2"
              ),
              [sty.freeBoxstepscharg_step3__brgxStdash]: hasVariant(
                $state,
                "stepscharg",
                "step3"
              )
          ...
          >
            <section
              className={classNames("all", sty.section__kqDW, {
                [sty.sectionstepscharg_step3__kqDWTdash]: hasVariant(
                  $state,
                  "stepscharg",
                  "step3"
                )
            ...
            >
              <HeaderPage
                ...
                className={classNames("__wab_instance", sty.headerPage, {
                  [sty.headerPagestepscharg_step1]: hasVariant(
                    $state,
                    "stepscharg",
                    "step1"
                  ),
            ...
            >
              ...
              >
                <Icon154Icon
                  className={classNames("all", sty.svg___61Lq, {
                    [sty.svgstepscharg_step1___61Lq0Mzt0]: hasVariant(
                      $state,
                      "stepscharg",
                      "step1"
                    ),
                    [sty.svgstepscharg_step3___61LqTdash]: hasVariant(
                      $state,
                      "stepscharg",
                      "step3"
                    )
                ...
                <div
                  ...
                  className={classNames("all", sty.steps, {
                    [sty.stepsstepscharg_step1]: hasVariant(
                      $state,
                      "stepscharg",
                      "step1"
                    ),
                ...
                >
                  <div
                    ...
                    className={classNames("all", sty.مشخصات, {
                      [sty.مشخصاتstepscharg_step1]: hasVariant(
                        $state,
                        "stepscharg",
                        "step1"
                      ),
                  ...
                  >
                    ...
                    <div
                      className={classNames(
                        ...
                        sty.text__naQN,
                        {
                          [sty.textstepscharg_step2__naQNKuLy5]: hasVariant(
                            $state,
                            "stepscharg",
                            "step2"
                          ),
                          [sty.textstepscharg_step3__naQNtdash]: hasVariant(
                            $state,
                            "stepscharg",
                            "step3"
                          )
                  ...
                  <LineXlSvgrepoComSvgIcon
                    className={classNames("all", sty.svg__jpKY)}
                    role={"img"}
                  />
                  ...
                  >
                    ...
                    <div
                      className={classNames(
                        ...
                        sty.text__ed3Pr,
                        {
                          [sty.textstepscharg_step1__ed3Pr0Mzt0]: hasVariant(
                            $state,
                            "stepscharg",
                            "step1"
                          ),
                          [sty.textstepscharg_step2__ed3PrKuLy5]: hasVariant(
                            $state,
                            "stepscharg",
                            "step2"
                          ),
                          [sty.textstepscharg_step3__ed3PrTdash]: hasVariant(
                            $state,
                            "stepscharg",
                            "step3"
                          )
                  ...
                  <LineXlSvgrepoComSvgIcon
                    className={classNames("all", sty.svg___0W1Az)}
                    role={"img"}
                  />
                  ...
                  >
                    ...
                    <div
                      className={classNames(
                        ...
                        sty.text__mzK9X,
                        {
                          [sty.textstepscharg_step2__mzK9XKuLy5]: hasVariant(
                            $state,
                            "stepscharg",
                            "step2"
                          ),
                          [sty.textstepscharg_step3__mzK9Xtdash]: hasVariant(
                            $state,
                            "stepscharg",
                            "step3"
                          )
                ...
                <div
                  className={classNames("all", sty.freeBox__naO5Q, {
                    [sty.freeBoxstepscharg_step2__naO5QKuLy5]: hasVariant(
                      $state,
                      "stepscharg",
                      "step2"
                    ),
                    [sty.freeBoxstepscharg_step3__naO5Qtdash]: hasVariant(
                      $state,
                      "stepscharg",
                      "step3"
                    )
                ...
                >
                  <div
                    className={classNames("all", sty.freeBox__im8Jd, {
                      [sty.freeBoxstepscharg_step1__im8Jd0Mzt0]: hasVariant(
                        $state,
                        "stepscharg",
                        "step1"
                      ),
                      [sty.freeBoxstepscharg_step2__im8JdKuLy5]: hasVariant(
                        $state,
                        "stepscharg",
                        "step2"
                      ),
                      [sty.freeBoxstepscharg_step3__im8JdTdash]: hasVariant(
                        $state,
                        "stepscharg",
                        "step3"
                      )
                  ...
                  >
                    <Embed
                      className={classNames(
                        "__wab_instance",
                        sty.embedHtml__pbEQz,
                        {
                          [sty.embedHtmlstepscharg_step1__pbEQz0Mzt0]:
                            hasVariant($state, "stepscharg", "step1"),
                          [sty.embedHtmlstepscharg_step3__pbEQzTdash]:
                            hasVariant($state, "stepscharg", "step3")
                        }
                      )}
                      code={
                  ...
                  <div
                    className={classNames(
                      ...
                      sty.text__g2WQg,
                      {
                        [sty.textstepscharg_step1__g2WQg0Mzt0]: hasVariant(
                          $state,
                          "stepscharg",
                          "step1"
                        ),
                        [sty.textstepscharg_step2__g2WQgKuLy5]: hasVariant(
                          $state,
                          "stepscharg",
                          "step2"
                        ),
                        [sty.textstepscharg_step3__g2WQgtdash]: hasVariant(
                          $state,
                          "stepscharg",
                          "step3"
                        )
                  ...
                  {(
                    ...
                    <div
                      className={classNames("all", sty.freeBox__k1Q0H, {
                        [sty.freeBoxstepscharg_step2__k1Q0HKuLy5]: hasVariant(
                          $state,
                          "stepscharg",
                          "step2"
                        ),
                        [sty.freeBoxstepscharg_step3__k1Q0HTdash]: hasVariant(
                          $state,
                          "stepscharg",
                          "step3"
                        )
                    ...
                    >
                      {(
                        ...
                        <div
                          className={classNames(
                            ...
                            sty.text__pLFb,
                            {
                              [sty.textstepscharg_step2__pLFbKuLy5]: hasVariant(
                                $state,
                                "stepscharg",
                                "step2"
                              ),
                              [sty.textstepscharg_step3__pLFbTdash]: hasVariant(
                                $state,
                                "stepscharg",
                                "step3"
                              )
                      ...
                      <div
                        className={classNames("all", sty.freeBox__gbmS, {
                          [sty.freeBoxstepscharg_step3__gbmSTdash]: hasVariant(
                            $state,
                            "stepscharg",
                            "step3"
                          )
                      ...
                      >
                        <div
                          className={classNames(
                            ...
                            sty.text__hPPah,
                            {
                              [sty.textstepscharg_step1__hPPah0Mzt0]:
                                hasVariant($state, "stepscharg", "step1"),
                              [sty.textstepscharg_step2__hPPahKuLy5]:
                                hasVariant($state, "stepscharg", "step2"),
                              [sty.textstepscharg_step3__hPPahTdash]:
                                hasVariant($state, "stepscharg", "step3")
                            }
                          )}
                        >
                  ...
                  {(
                    ...
                    <div
                      className={classNames("all", sty.freeBox__lodG2, {
                        [sty.freeBoxstepscharg_step2__lodG2KuLy5]: hasVariant(
                          $state,
                          "stepscharg",
                          "step2"
                        ),
                        [sty.freeBoxstepscharg_step3__lodG2Tdash]: hasVariant(
                          $state,
                          "stepscharg",
                          "step3"
                        )
                      ...
                      {(
                        ...
                        <div
                          className={classNames(
                            ...
                            sty.text__xbRjZ,
                            {
                              [sty.textstepscharg_step2__xbRjZKuLy5]:
                                hasVariant($state, "stepscharg", "step2"),
                              [sty.textstepscharg_step3__xbRjZtdash]:
                                hasVariant($state, "stepscharg", "step3")
                            }
                          )}
                        >
                      ...
                      {(
                        ...
                        <div
                          className={classNames(
                            ...
                            sty.text__sYbVl,
                            {
                              [sty.textstepscharg_step2__sYbVlKuLy5]:
                                hasVariant($state, "stepscharg", "step2"),
                              [sty.textstepscharg_step3__sYbVltdash]:
                                hasVariant($state, "stepscharg", "step3")
                            }
                          )}
                        >
                  ...
                  {(
                    ...
                    <div
                      className={classNames("all", sty.freeBox___93X7I, {
                        [sty.freeBoxstepscharg_step1___93X7I0Mzt0]: hasVariant(
                          $state,
                          "stepscharg",
                          "step1"
                        ),
                        [sty.freeBoxstepscharg_step2___93X7IKuLy5]: hasVariant(
                          $state,
                          "stepscharg",
                          "step2"
                        ),
                        [sty.freeBoxstepscharg_step3___93X7Itdash]: hasVariant(
                          $state,
                          "stepscharg",
                          "step3"
                        )
                      ...
                      {(
                        ...
                        <div
                          className={classNames(
                            ...
                            sty.text__xqyr6,
                            {
                              [sty.textstepscharg_step2__xqyr6KuLy5]:
                                hasVariant($state, "stepscharg", "step2"),
                              [sty.textstepscharg_step3__xqyr6Tdash]:
                                hasVariant($state, "stepscharg", "step3")
                            }
                          )}
                        >
                      ...
                      {(
                        ...
                        <div
                          className={classNames(
                            ...
                            sty.text___1Of3S,
                            {
                              [sty.textstepscharg_step2___1Of3SKuLy5]:
                                hasVariant($state, "stepscharg", "step2"),
                              [sty.textstepscharg_step3___1Of3STdash]:
                                hasVariant($state, "stepscharg", "step3")
                            }
                          )}
                        >
                  ...
                  {(
                    ...
                    <div
                      className={classNames("all", sty.freeBox__b4IU, {
                        [sty.freeBoxstepscharg_step1__b4IU0Mzt0]: hasVariant(
                          $state,
                          "stepscharg",
                          "step1"
                        ),
                        [sty.freeBoxstepscharg_step2__b4IUKuLy5]: hasVariant(
                          $state,
                          "stepscharg",
                          "step2"
                        ),
                        [sty.freeBoxstepscharg_step3__b4IUTdash]: hasVariant(
                          $state,
                          "stepscharg",
                          "step3"
                        )
                      ...
                      {(
                        ...
                        <div
                          className={classNames(
                            ...
                            sty.text__v4Gx,
                            {
                              [sty.textstepscharg_step2__v4GxKuLy5]: hasVariant(
                                $state,
                                "stepscharg",
                                "step2"
                              ),
                              [sty.textstepscharg_step3__v4GxTdash]: hasVariant(
                                $state,
                                "stepscharg",
                                "step3"
                              )
                      ...
                      {(
                        ...
                        <div
                          className={classNames(
                            ...
                            sty.text__ib34Q,
                            {
                              [sty.textstepscharg_step2__ib34QKuLy5]:
                                hasVariant($state, "stepscharg", "step2"),
                              [sty.textstepscharg_step3__ib34QTdash]:
                                hasVariant($state, "stepscharg", "step3")
                            }
                          )}
                        >
                  ...
                  {(
                    ...
                    <div
                      className={classNames("all", sty.freeBox__c52J, {
                        [sty.freeBoxstepscharg_step1__c52J0Mzt0]: hasVariant(
                          $state,
                          "stepscharg",
                          "step1"
                        ),
                        [sty.freeBoxstepscharg_step2__c52JKuLy5]: hasVariant(
                          $state,
                          "stepscharg",
                          "step2"
                        ),
                        [sty.freeBoxstepscharg_step3__c52JTdash]: hasVariant(
                          $state,
                          "stepscharg",
                          "step3"
                        )
                      ...
                      {(
                        ...
                        <div
                          className={classNames(
                            ...
                            sty.text___4Q6Lc,
                            {
                              [sty.textstepscharg_step2___4Q6LcKuLy5]:
                                hasVariant($state, "stepscharg", "step2"),
                              [sty.textstepscharg_step3___4Q6LcTdash]:
                                hasVariant($state, "stepscharg", "step3")
                            }
                          )}
                        >
                      ...
                      {(
                        ...
                        <div
                          className={classNames(
                            ...
                            sty.text__fU7Gh,
                            {
                              [sty.textstepscharg_step2__fU7GhKuLy5]:
                                hasVariant($state, "stepscharg", "step2"),
                              [sty.textstepscharg_step3__fU7GhTdash]:
                                hasVariant($state, "stepscharg", "step3")
                            }
                          )}
                        >
                  ...
                  <div
                    className={classNames("all", sty.freeBox__pVu9E, {
                      [sty.freeBoxstepscharg_step2__pVu9EKuLy5]: hasVariant(
                        $state,
                        "stepscharg",
                        "step2"
                      ),
                      [sty.freeBoxstepscharg_step3__pVu9Etdash]: hasVariant(
                        $state,
                        "stepscharg",
                        "step3"
                      )
                    ...
                    {(
                      ...
                      <div
                        className={classNames(
                          ...
                          sty.text__fjdA,
                          {
                            [sty.textstepscharg_step2__fjdAKuLy5]: hasVariant(
                              $state,
                              "stepscharg",
                              "step2"
                            ),
                            [sty.textstepscharg_step3__fjdATdash]: hasVariant(
                              $state,
                              "stepscharg",
                              "step3"
                            )
                    ...
                    {(
                      ...
                      <div
                        className={classNames(
                          ...
                          sty.text__qOzCg,
                          {
                            [sty.textstepscharg_step1__qOzCg0Mzt0]: hasVariant(
                              $state,
                              "stepscharg",
                              "step1"
                            ),
                            [sty.textstepscharg_step2__qOzCgKuLy5]: hasVariant(
                              $state,
                              "stepscharg",
                              "step2"
                            ),
                            [sty.textstepscharg_step3__qOzCgtdash]: hasVariant(
                              $state,
                              "stepscharg",
                              "step3"
                            )
...
`;
                ...
                <div
                  className={classNames("all", sty.freeBox___4D83V, {
                    [sty.freeBoxstepscharg_step1___4D83V0Mzt0]: hasVariant(
                      $state,
                      "stepscharg",
                      "step1"
                    ),
                    [sty.freeBoxstepscharg_step2___4D83VKuLy5]: hasVariant(
                      $state,
                      "stepscharg",
                      "step2"
                    ),
                    [sty.freeBoxstepscharg_step3___4D83VTdash]: hasVariant(
                      $state,
                      "stepscharg",
                      "step3"
                    )
                ...
                >
                  {(
                    ...
                    <div
                      className={classNames("all", sty.freeBox__drhPq, {
                        [sty.freeBoxstepscharg_step1__drhPq0Mzt0]: hasVariant(
                          $state,
                          "stepscharg",
                          "step1"
                        )
                  ...
                  <div
                    className={classNames("all", sty.freeBox__ouUf, {
                      [sty.freeBoxstepscharg_step1__ouUf0Mzt0]: hasVariant(
                        $state,
                        "stepscharg",
                        "step1"
                      )
                  ...
                  >
                    <div
                      className={classNames(
                        ...
                        sty.text__jGgP2,
                        {
                          [sty.textstepscharg_step1__jGgP20Mzt0]: hasVariant(
                            $state,
                            "stepscharg",
                            "step1"
                          ),
                          [sty.textstepscharg_step2__jGgP2KuLy5]: hasVariant(
                            $state,
                            "stepscharg",
                            "step2"
                          ),
                          [sty.textstepscharg_step3__jGgP2Tdash]: hasVariant(
                            $state,
                            "stepscharg",
                            "step3"
                          )
                  ...
                  {(
                    ...
                    <div
                      className={classNames("all", sty.freeBox__k2KD, {
                        [sty.freeBoxstepscharg_step1__k2KD0Mzt0]: hasVariant(
                          $state,
                          "stepscharg",
                          "step1"
                        )
                    ...
                    >
                      <div
                        className={classNames(
                          ...
                          sty.text__uIj3E,
                          {
                            [sty.textstepscharg_step1__uIj3E0Mzt0]: hasVariant(
                              $state,
                              "stepscharg",
                              "step1"
                            ),
                            [sty.textstepscharg_step2__uIj3EKuLy5]: hasVariant(
                              $state,
                              "stepscharg",
                              "step2"
                            ),
                            [sty.textstepscharg_step3__uIj3ETdash]: hasVariant(
                              $state,
                              "stepscharg",
                              "step3"
                            )
                  ...
                  {(
                    ...
                    <div
                      className={classNames("all", sty.freeBox___0OvLj, {
                        [sty.freeBoxstepscharg_step1___0OvLj0Mzt0]: hasVariant(
                          $state,
                          "stepscharg",
                          "step1"
                        ),
                        [sty.freeBoxstepscharg_step2___0OvLjKuLy5]: hasVariant(
                          $state,
                          "stepscharg",
                          "step2"
                        )
                    ...
                    >
                      <div
                        className={classNames(
                          ...
                          sty.text___1NUQt,
                          {
                            [sty.textstepscharg_step1___1NUQt0Mzt0]: hasVariant(
                              $state,
                              "stepscharg",
                              "step1"
                            ),
                            [sty.textstepscharg_step2___1NUQtKuLy5]: hasVariant(
                              $state,
                              "stepscharg",
                              "step2"
                            ),
                            [sty.textstepscharg_step3___1NUQtTdash]: hasVariant(
                              $state,
                              "stepscharg",
                              "step3"
                            )
                      ...
                      <PlasmicImg__
                        alt={""}
                        className={classNames(sty.img__chi4F, {
                          [sty.imgstepscharg_step1__chi4F0Mzt0]: hasVariant(
                            $state,
                            "stepscharg",
                            "step1"
                          )
                  ...
                  {(
                    ...
                    <div
                      ...
                      className={classNames("all", sty.billId, {
                    ...
                    >
                      <div
                        className={classNames(
                          ...
                          sty.text__vJfp,
                          {
                            [sty.textstepscharg_step1__vJfp0Mzt0]: hasVariant(
                              $state,
                              "stepscharg",
                              "step1"
                            ),
                            [sty.textstepscharg_step2__vJfpKuLy5]: hasVariant(
                              $state,
                              "stepscharg",
                              "step2"
                            ),
                            [sty.textstepscharg_step3__vJfpTdash]: hasVariant(
                              $state,
                              "stepscharg",
                              "step3"
                            )
                  ...
                  {(
                    ...
                    <div
                      ...
                      className={classNames("all", sty.billId3, {
                    ...
                    >
                      <div
                        className={classNames(
                          ...
                          sty.text__u07Sh,
                          {
                            [sty.textstepscharg_step1__u07Sh0Mzt0]: hasVariant(
                              $state,
                              "stepscharg",
                              "step1"
                            ),
                            [sty.textstepscharg_step2__u07ShKuLy5]: hasVariant(
                              $state,
                              "stepscharg",
                              "step2"
                            ),
                            [sty.textstepscharg_step3__u07ShTdash]: hasVariant(
                              $state,
                              "stepscharg",
                              "step3"
                            )
                  ...
                  {(
                    ...
                    <div
                      ...
                      className={classNames("all", sty.billId2, {
                    ...
                    >
                      <div
                        className={classNames(
                          ...
                          sty.text__wmTIj,
                          {
                            [sty.textstepscharg_step1__wmTIj0Mzt0]: hasVariant(
                              $state,
                              "stepscharg",
                              "step1"
                            ),
                            [sty.textstepscharg_step2__wmTIjKuLy5]: hasVariant(
                              $state,
                              "stepscharg",
                              "step2"
                            ),
                            [sty.textstepscharg_step3__wmTIjTdash]: hasVariant(
                              $state,
                              "stepscharg",
                              "step3"
                            )
              ...
              <div
                className={classNames("all", sty.freeBox__cRv0, {
                  [sty.freeBoxstepscharg_step1__cRv00Mzt0]: hasVariant(
                    $state,
                    "stepscharg",
                    "step1"
                  ),
                  [sty.freeBoxstepscharg_step2__cRv0KuLy5]: hasVariant(
                    $state,
                    "stepscharg",
                    "step2"
                  ),
                  [sty.freeBoxstepscharg_step3__cRv0Tdash]: hasVariant(
                    $state,
                    "stepscharg",
                    "step3"
                  )
              ...
              >
                <div
                  className={classNames("all", "__wab_text", sty.text__utUkq, {
                    [sty.textstepscharg_step2__utUkqKuLy5]: hasVariant(
                      $state,
                      "stepscharg",
                      "step2"
                    )
                ...
                <div
                  ...
                  className={classNames("all", sty.operators, {
                    [sty.operatorsstepscharg_step1]: hasVariant(
                      $state,
                      "stepscharg",
                      "step1"
                    ),
                    ...
                    return (() => {
                      ...
                      return (
                        ...
                        >
                          <PlasmicImg__
                            alt={""}
                            className={classNames(sty.img__gdvQg, {
                              [sty.imgstepscharg_step3__gdvQgTdash]: hasVariant(
                                $state,
                                "stepscharg",
                                "step3"
                              )
              ...
              {(hasVariant($state, "stepscharg", "step2") ? true : false) ? (
                <div
                  className={classNames("all", sty.freeBox__fr6Dc, {
                    [sty.freeBoxstepscharg_step1__fr6Dc0Mzt0]: hasVariant(
                      $state,
                      "stepscharg",
                      "step1"
                    ),
                    [sty.freeBoxstepscharg_step2__fr6DcKuLy5]: hasVariant(
                      $state,
                      "stepscharg",
                      "step2"
                    ),
                    [sty.freeBoxstepscharg_step3__fr6Dctdash]: hasVariant(
                      $state,
                      "stepscharg",
                      "step3"
                    )
                ...
                >
                  <div
                    className={classNames(
                      ...
                      sty.text___7EtTy,
                      {
                        [sty.textstepscharg_step2___7EtTyKuLy5]: hasVariant(
                          $state,
                          "stepscharg",
                          "step2"
                        ),
                        [sty.textstepscharg_step3___7EtTyTdash]: hasVariant(
                          $state,
                          "stepscharg",
                          "step3"
                        )
                    ...
                    {(_par =>
                      ...
                      return (() => {
                        ...
                        return (
                          ...
                          >
                            <div
                              className={classNames("all", sty.freeBox__uZaTh, {
                                [sty.freeBoxstepscharg_step2__uZaThKuLy5]:
                                  hasVariant($state, "stepscharg", "step2")
                              })}
                            >
                              <div
                                className={classNames(
                                  ...
                                  sty.text__fpbfi,
                                  {
                                    [sty.textstepscharg_step2__fpbfiKuLy5]:
                                      hasVariant($state, "stepscharg", "step2")
                                  }
                                )}
                              >
              ...
              <div
                className={classNames("all", sty.freeBox__d5SCw, {
                  [sty.freeBoxstepscharg_step1__d5SCw0Mzt0]: hasVariant(
                    $state,
                    "stepscharg",
                    "step1"
                  ),
                  [sty.freeBoxstepscharg_step2__d5SCwKuLy5]: hasVariant(
                    $state,
                    "stepscharg",
                    "step2"
                  ),
                  [sty.freeBoxstepscharg_step3__d5SCwTdash]: hasVariant(
                    $state,
                    "stepscharg",
                    "step3"
                  )
              ...
              >
                ...
                {(hasVariant($state, "stepscharg", "step3") ? true : false) ? (
                  <div
                    className={classNames("all", sty.freeBox__hw4Qh, {
                      [sty.freeBoxstepscharg_step3__hw4QhTdash]: hasVariant(
                        $state,
                        "stepscharg",
                        "step3"
                      )
                  ...
                  >
                    <Group4SvgIcon
                      className={classNames("all", sty.svg__koD9L, {
                        [sty.svgstepscharg_step3__koD9Ltdash]: hasVariant(
                          $state,
                          "stepscharg",
                          "step3"
                        )
                    ...
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__eSlB, {
                        [sty.imgstepscharg_step3__eSlBTdash]: hasVariant(
                          $state,
                          "stepscharg",
                          "step3"
                        )
                    ...
                    <div
                      className={classNames("all", sty.freeBox__l53Hq, {
                        [sty.freeBoxstepscharg_step3__l53Hqtdash]: hasVariant(
                          $state,
                          "stepscharg",
                          "step3"
                        )
                    ...
                    >
                      <div
                        className={classNames(
                          ...
                          sty.text___3Ua6C,
                          {
                            [sty.textstepscharg_step3___3Ua6CTdash]: hasVariant(
                              $state,
                              "stepscharg",
                              "step3"
                            )
                      ...
                      <div
                        className={classNames(
                          ...
                          sty.text__bG6Ot,
                          {
                            [sty.textstepscharg_step2__bG6OtKuLy5]: hasVariant(
                              $state,
                              "stepscharg",
                              "step2"
                            ),
                            [sty.textstepscharg_step3__bG6OtTdash]: hasVariant(
                              $state,
                              "stepscharg",
                              "step3"
                            )
                    ...
                    <Group7SvgIcon
                      className={classNames("all", sty.svg___8ZW9N, {
                        [sty.svgstepscharg_step3___8ZW9Ntdash]: hasVariant(
                          $state,
                          "stepscharg",
                          "step3"
                        )
              ...
              {(
                ...
                <div
                  ...
                  className={classNames("all", sty.nobill, {
                ...
                >
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img__jca24, {
                      [sty.imgstepscharg_step1__jca240Mzt0]: hasVariant(
                        $state,
                        "stepscharg",
                        "step1"
                      )
                  ...
                  <div
                    className={classNames(
                      ...
                      sty.text__isU2Q,
                      {
                        [sty.textstepscharg_step1__isU2Q0Mzt0]: hasVariant(
                          $state,
                          "stepscharg",
                          "step1"
                        )
                  ...
                  <div
                    className={classNames("all", "__wab_text", sty.text__d5Ud)}
                  >
                    {
                      "\u0627\u0648\u0644\u06cc\u0646 \u0634\u0627\u0631\u0698 \u062d\u0633\u0627\u0628 \u0631\u0627 \u0627\u0646\u062c\u0627\u0645 \u062f\u0647\u06cc\u062f"
                    }
                  </div>
                </div>
              ) : null}
              {(
                ...
                <div
                  ...
                  className={classNames("all", sty.bills, {
                ...
                >
                  <div
                    className={classNames("all", "__wab_text", sty.text__uXlAz)}
                  >
                    {
                  ...
                  {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
                    ...
                    return (
                      <div
                        className={classNames("all", sty.freeBox__y51Nq, {
                          [sty.freeBoxstepscharg_step1__y51Nq0Mzt0]: hasVariant(
                            $state,
                            "stepscharg",
                            "step1"
                          ),
                          [sty.freeBoxstepscharg_step2__y51NqKuLy5]: hasVariant(
                            $state,
                            "stepscharg",
                            "step2"
                          ),
                          [sty.freeBoxstepscharg_step3__y51NqTdash]: hasVariant(
                            $state,
                            "stepscharg",
                            "step3"
                          )
                      ...
                      >
                        <Embed
                          className={classNames(
                            "__wab_instance",
                            sty.embedHtml__w4Zuf,
                            {
                              [sty.embedHtmlstepscharg_step1__w4Zuf0Mzt0]:
                                hasVariant($state, "stepscharg", "step1")
                            }
                          )}
                          code={(() => {
                        ...
                        <div
                          className={classNames("all", sty.freeBox__j3GQl)}
                          onClick={async event => {
                            const $steps = {};
                        ...
                        {(() => {
                          ...
                          return (
                            ...
                            >
                              <Icon109Icon
                                className={classNames("all", sty.svg__e8ZDy)}
                                role={"img"}
                              />
                            </AntdPopover>
                          );
                        ...
                        <Icon108Icon
                          className={classNames("all", sty.svg__ihwj7)}
                          role={"img"}
                        />
                      </div>
                    );
            ...
            <section className={classNames("all", sty.section__kSBkz)}>
              <div
                className={classNames("all", sty.freeBox__klt6B, {
                  [sty.freeBoxstepscharg_step1__klt6B0Mzt0]: hasVariant(
                    $state,
                    "stepscharg",
                    "step1"
                  ),
                  [sty.freeBoxstepscharg_step2__klt6BKuLy5]: hasVariant(
                    $state,
                    "stepscharg",
                    "step2"
                  ),
                  [sty.freeBoxstepscharg_step3__klt6Btdash]: hasVariant(
                    $state,
                    "stepscharg",
                    "step3"
                  )
              ...
              >
                  ...
                  >
                    <div
                      className={classNames(
                        ...
                        sty.text__j6YqS,
                        {
                          [sty.textstepscharg_step2__j6YqSKuLy5]: hasVariant(
                            $state,
                            "stepscharg",
                            "step2"
                          )
                ...
                <div
                  className={classNames("all", sty.freeBox__xt5O2, {
                    [sty.freeBoxstepscharg_step1__xt5O20Mzt0]: hasVariant(
                      $state,
                      "stepscharg",
                      "step1"
                    ),
                    [sty.freeBoxstepscharg_step3__xt5O2Tdash]: hasVariant(
                      $state,
                      "stepscharg",
                      "step3"
                    )
                ...
                >
                  {(
                    ...
                    >
                      <div
                        className={classNames("all", sty.freeBox__zm17S, {
                          [sty.freeBoxstepscharg_step1__zm17S0Mzt0]: hasVariant(
                            $state,
                            "stepscharg",
                            "step1"
                          )
                      ...
                      >
                        <Icon95Icon
                          className={classNames("all", sty.svg__r81SI, {
                            [sty.svgstepscharg_step1__r81SI0Mzt0]: hasVariant(
                              $state,
                              "stepscharg",
                              "step1"
                            )
                        ...
                        <div
                          className={classNames(
                            ...
                            sty.text__twq2L,
                            {
                              [sty.textstepscharg_step1__twq2L0Mzt0]:
                                hasVariant($state, "stepscharg", "step1")
                            }
                          )}
                        >
                  ...
                  <div
                    className={classNames(
                      ...
                      sty.text__zGFio,
                      {
                        [sty.textstepscharg_step1__zGFio0Mzt0]: hasVariant(
                          $state,
                          "stepscharg",
                          "step1"
                        )
                  ...
                  {(
                    ...
                    <div
                      className={classNames(
                        ...
                        sty.text__c1D7D,
                        {
                          [sty.textstepscharg_step1__c1D7D0Mzt0]: hasVariant(
                            $state,
                            "stepscharg",
                            "step1"
                          )
                  ...
                  <div
                    className={classNames("all", sty.freeBox__lnSeJ, {
                      [sty.freeBoxstepscharg_step1__lnSeJ0Mzt0]: hasVariant(
                        $state,
                        "stepscharg",
                        "step1"
                      )
                    ...
                    >
                      <div
                        className={classNames(
                          ...
                          sty.text__iFYz,
                          {
                            [sty.textstepscharg_step1__iFYz0Mzt0]: hasVariant(
                              $state,
                              "stepscharg",
                              "step1"
                            )
                    ...
                    >
                      <div
                        className={classNames(
                          ...
                          sty.text__uOagM,
                          {
                            [sty.textstepscharg_step1__uOagM0Mzt0]: hasVariant(
                              $state,
                              "stepscharg",
                              "step1"
                            ),
                            [sty.textstepscharg_step2__uOagMKuLy5]: hasVariant(
                              $state,
                              "stepscharg",
                              "step2"
                            )
                  ...
                  <Embed
                    className={classNames(
                      "__wab_instance",
                      sty.embedHtml__x8IvQ,
                      {
                        [sty.embedHtmlstepscharg_step1__x8IvQ0Mzt0]: hasVariant(
                          $state,
                          "stepscharg",
                          "step1"
                        ),
                        [sty.embedHtmlstepscharg_step3__x8IvQtdash]: hasVariant(
                          $state,
                          "stepscharg",
                          "step3"
                        )
                ...
                <Button
                  ...
                  endIcon={
                    <Icon3Icon
                      className={classNames("all", sty.svg__kJFaM)}
                      role={"img"}
                    />
                  }
                  isDisabled={(() => {
                  ...
                  startIcon={
                    <Icon92Icon
                      className={classNames("all", sty.svg___9HeQf)}
                      role={"img"}
                    />
                  }
                >
                  <div
                    className={classNames(
                      ...
                      sty.text__ws4AJ,
                      {
                        [sty.textstepscharg_step1__ws4AJ0Mzt0]: hasVariant(
                          $state,
                          "stepscharg",
                          "step1"
                        )
                ...
                {(
                  ...
                  <div
                    className={classNames(
                      ...
                      sty.text__iBgC7,
                      {
                        [sty.textstepscharg_step1__iBgC70Mzt0]: hasVariant(
                          $state,
                          "stepscharg",
                          "step1"
                        ),
                        [sty.textstepscharg_step2__iBgC7KuLy5]: hasVariant(
                          $state,
                          "stepscharg",
                          "step2"
                        ),
                        [sty.textstepscharg_step3__iBgC7Tdash]: hasVariant(
                          $state,
                          "stepscharg",
                          "step3"
                        )
            ...
            <AntdModal
              ...
              modalContentClassName={classNames({
                [sty["pcls_JonTPMBCB7tS"]]: true,
                [sty["pcls_hqm17w8Y2IpA"]]: hasVariant(
                  $state,
                  "stepscharg",
                  "step3"
                )
              ...
              trigger={null}
            >
              <div className={classNames("all", sty.freeBox___8UNPy)}>
                <div
                  className={classNames("all", "__wab_text", sty.text__dihd4)}
                >
                  {
                    "\u062a\u0648\u0636\u06cc\u062d\u0627\u062a \u062e\u0631\u06cc\u062f \u0634\u0627\u0631\u0698"
                  }
                ...
                <div
                  className={classNames("all", "__wab_text", sty.text___7Iraw)}
                >
                  {
                    "\u06af\u0627\u0645 \u0647\u0627\u06cc \u062e\u0631\u06cc\u062f \u0634\u0627\u0631\u0698:"
                  }
                ...
                >
                  ...
                  >
                    <div className={classNames("all", sty.freeBox__osoj)}>
                      <div
                        className={classNames(
                          "all",
                          "__wab_text",
                  ...
                  >
                    <div className={classNames("all", sty.freeBox__tXBhm)}>
                      <div
                        data-plasmic-name={
                          "\u0627\u067e\u0631\u0627\u062a\u0648\u0631"
                        }
                  ...
                  >
                    <div className={classNames("all", sty.freeBox__fBa8T)}>
                      <div
                        data-plasmic-name={
                          "\u0627\u067e\u0631\u0627\u062a\u0648\u06312"
                        }
                  ...
                  >
                    <div className={classNames("all", sty.freeBox__z6Gre)}>
                      <div
                        data-plasmic-name={
                          "\u0627\u067e\u0631\u0627\u062a\u0648\u06313"
                        }
            ...
            <AntdModal
              ...
              modalContentClassName={classNames({
                [sty["pcls_9qv455mgGHxb"]]: true,
                [sty["pcls_KvecSOFBTp5Z"]]: hasVariant(
                  $state,
                  "stepscharg",
                  "step3"
                ),
                [sty["pcls_oH_mplx07ALV"]]:
                  hasVariant($state, "stepscharg", "step3") &&
                  hasVariant(globalVariants, "screen", "mobileOnly")
              })}
              ...
              wrapClassName={classNames({
                [sty["pcls_EycBXGBoJzvz"]]: hasVariant(
                  $state,
                  "stepscharg",
                  "step3"
                ),
                [sty["pcls_b305FVIut0qr"]]:
                  hasVariant($state, "stepscharg", "step3") &&
                  hasVariant(globalVariants, "screen", "mobileOnly")
              })}
            >
              <div
                className={classNames("all", sty.freeBox__uFfc9, {
                  [sty.freeBoxstepscharg_step3__uFfc9Tdash]: hasVariant(
                    $state,
                    "stepscharg",
                    "step3"
                  )
              ...
              >
                ...
                <div
                  className={classNames("all", "__wab_text", sty.text__fHeYm, {
                    [sty.textstepscharg_step3__fHeYmtdash]: hasVariant(
                      $state,
                      "stepscharg",
                      "step3"
                    )
                ...
                <div
                  className={classNames("all", sty.freeBox__mDeh4, {
                    [sty.freeBoxstepscharg_step3__mDeh4Tdash]: hasVariant(
                      $state,
                      "stepscharg",
                      "step3"
                    )
                ...
                >
                  ...
                  <div
                    className={classNames(
                      ...
                      sty.text___79Qk,
                      {
                        [sty.textstepscharg_step3___79Qktdash]: hasVariant(
                          $state,
                          "stepscharg",
                          "step3"
                        )
                ...
                <div className={classNames("all", sty.freeBox__y7FNi)}>
                  <div
                    className={classNames("all", "__wab_text", sty.text__xaM9X)}
                  >
                    {
                      "\u0634\u0646\u0627\u0633\u0647 \u062a\u0631\u0627\u06a9\u0646\u0634"
                    }
                  ...
                  <div
                    className={classNames("all", "__wab_text", sty.text__xStM, {
                      [sty.textstepscharg_step3__xStMtdash]: hasVariant(
                        $state,
                        "stepscharg",
                        "step3"
                      )
                ...
                >
                  <div
                    className={classNames("all", "__wab_text", sty.text__m6Yn4)}
                  >
                    {"\u062a\u0627\u06cc\u06cc\u062f"}
                  </div>
                </Button>
        ...
        <ApiRequest
          ...
          errorDisplay={
            <div className={classNames("all", "__wab_text", sty.text__klQnd)}>
              {"Error fetching data"}
            </div>
          }
          loadingDisplay={
            <div className={classNames("all", "__wab_text", sty.text___0HBdx)}>
              {"Loading..."}
            </div>
          }
          method={"GET"}
        ...
        <AntdModal
          ...
          closeButtonClassName={classNames({
            [sty["pcls_XZFzp2rRHDif"]]: true
          })}
          closeIcon={
            <div className={classNames("all", "__wab_text", sty.text___48NSq)}>
              {"\n"}
            </div>
          }
          defaultStylesClassName={classNames(
        ...
        >
          <div className={classNames("all", sty.freeBox__cR3L1)}>
            <div className={classNames("all", sty.freeBox__wUiRr)}>
              <Icon78Icon
                className={classNames("all", sty.svg__lnRbI)}
                role={"img"}
              />

              <div className={classNames("all", "__wab_text", sty.text__gTKf2)}>
                {"\u0642\u0628\u0636 \u062c\u062f\u06cc\u062f"}
              </div>
            </div>
            <Icon89Icon
              className={classNames("all", sty.svg___2JHdH)}
              onClick={async event => {
                const $steps = {};
          ...
          <div className={classNames("all", sty.freeBox__e1ZI)}>
            <div
              data-plasmic-name={"comingSoon19"}
              data-plasmic-override={overrides.comingSoon19}
              className={classNames("all", sty.comingSoon19)}
              onClick={async event => {
                const $steps = {};
            ...
            >
              <Icon98Icon
                className={classNames("all", sty.svg__rn52)}
                role={"img"}
              />

              <div
                className={classNames("all", "__wab_text", sty.text___8Nt76)}
              >
                {"\u0642\u0628\u0636 \u0628\u0631\u0642"}
              </div>
            </div>
            <div
              ...
              className={classNames("all", sty.comingSoon20)}
              onClick={async event => {
                const $steps = {};
            ...
            >
              <Icon99Icon
                className={classNames("all", sty.svg__u8XFx)}
                role={"img"}
              />

              <div className={classNames("all", "__wab_text", sty.text__hacyn)}>
                {"\u0642\u0628\u0636 \u06af\u0627\u0632"}
              </div>
            </div>
            <div
              ...
              className={classNames("all", sty.comingSoon21)}
              onClick={async event => {
                const $steps = {};
            ...
            >
              <Icon100Icon
                className={classNames("all", sty.svg__dveC8)}
                role={"img"}
              />

              <div className={classNames("all", "__wab_text", sty.text__pmayv)}>
                {"\u0642\u0628\u0636 \u0622\u0628"}
              </div>
            </div>
            <div
              ...
              className={classNames("all", sty.comingSoon22, {
            ...
            >
              <Icon101Icon
                className={classNames("all", sty.svg___0HfBv)}
                role={"img"}
              />

              <div
                className={classNames("all", "__wab_text", sty.text___7O09L)}
              >
                {
                  "\u0642\u0628\u0636 \u062a\u0644\u0641\u0646 \u062b\u0627\u0628\u062a"
                }
            ...
            <div
              ...
              className={classNames("all", sty.comingSoon23)}
              onClick={async event => {
                const $steps = {};
            ...
            >
              <Icon102Icon
                className={classNames("all", sty.svg__eWjjC)}
                role={"img"}
              />

              <div className={classNames("all", "__wab_text", sty.text__yxXwP)}>
                {
                  "\u0642\u0628\u0636 \u0633\u06cc\u0645 \u06a9\u0627\u0631\u062a \u062f\u0627\u0626\u0645\u06cc"
                }
              </div>
            ...
            <div
              ...
              className={classNames("all", sty.comingSoon24)}
              onClick={async event => {
                const $steps = {};
            ...
            >
              <Icon104Icon
                className={classNames("all", sty.svg__qkHzz)}
                role={"img"}
              />

              <div className={classNames("all", "__wab_text", sty.text__sl3Ju)}>
                {"\u0633\u0627\u06cc\u0631 \u0642\u0628\u0636 \u0647\u0627"}
              </div>
            </div>
          </div>
        ...
        {(hasVariant($state, "stepscharg", "step3") ? true : false) ? (
          <AntdModal
            ...
            closeButtonClassName={classNames({
              [sty["pcls_suIJKhKFCI-N"]]: true
            })}
            closeIcon={
              <div className={classNames("all", "__wab_text", sty.text__l1Qkf)}>
                {"\n"}
              </div>
            }
            defaultStylesClassName={classNames(
          ...
          >
            <div className={classNames("all", sty.freeBox__xPsto)}>
              <div className={classNames("all", sty.freeBox__fnWyi)}>
                <Icon78Icon
                  className={classNames("all", sty.svg__eYbiG)}
                  role={"img"}
                />

                <div
                  className={classNames("all", "__wab_text", sty.text__abEa)}
                >
                  {"\u062c\u0632\u06cc\u06cc\u0627\u062a \u0642\u0628\u0636 "}
                </div>
              </div>
              <Icon89Icon
                className={classNames("all", sty.svg__sXiSz)}
                onClick={async event => {
                  const $steps = {};
            ...
            <div className={classNames("all", sty.freeBox__wZs0P)}>
              <div className={classNames("all", sty.freeBox___9Majo)}>
                <div
                  className={classNames("all", "__wab_text", sty.text__kNtO)}
                >
                  {"\u0646\u0627\u0645"}
                </div>
                <div
                  className={classNames("all", "__wab_text", sty.text___1Brct)}
                >
                  {
                    "\u0627\u0644\u0647\u0647 \u0627\u0645\u06cc\u0631 \u0639\u0628\u0627\u0633\u06cc"
                  }
              ...
              <div className={classNames("all", sty.freeBox___2Briw)}>
                <div
                  className={classNames("all", "__wab_text", sty.text__m5RrA)}
                >
                  {"\u0646\u0627\u0645"}
                </div>
                <div
                  className={classNames("all", "__wab_text", sty.text__ypjha)}
                >
                  {
                    "\u0627\u0644\u0647\u0647 \u0627\u0645\u06cc\u0631 \u0639\u0628\u0627\u0633\u06cc"
                  }
              ...
              <div className={classNames("all", sty.freeBox__jsdzy)}>
                <div
                  className={classNames("all", "__wab_text", sty.text__vpVw)}
                >
                  {"\u0646\u0627\u0645"}
                </div>
                <div
                  className={classNames("all", "__wab_text", sty.text__kBOiY)}
                >
                  {
                    "\u0627\u0644\u0647\u0647 \u0627\u0645\u06cc\u0631 \u0639\u0628\u0627\u0633\u06cc"
                  }
              ...
              <div className={classNames("all", sty.freeBox__am2Sd)}>
                <div
                  className={classNames("all", "__wab_text", sty.text__mnJsx)}
                >
                  {"\u0646\u0627\u0645"}
                </div>
                <div
                  className={classNames("all", "__wab_text", sty.text__zn6O)}
                >
                  {
                    "\u0627\u0644\u0647\u0647 \u0627\u0645\u06cc\u0631 \u0639\u0628\u0627\u0633\u06cc"
                  }
              ...
              <div className={classNames("all", sty.freeBox__vwVo)}>
                <div
                  className={classNames("all", "__wab_text", sty.text___8LoJh)}
                >
                  {"\u0646\u0627\u0645"}
                </div>
                <div
                  className={classNames("all", "__wab_text", sty.text__pEFgh)}
                >
                  {
                    "\u0627\u0644\u0647\u0647 \u0627\u0645\u06cc\u0631 \u0639\u0628\u0627\u0633\u06cc"
                  }
              ...
              <div className={classNames("all", sty.freeBox__zxRgj)}>
                <div
                  className={classNames("all", "__wab_text", sty.text__aTfnK)}
                >
                  {"\u0646\u0627\u0645"}
                </div>
                <div
                  className={classNames("all", "__wab_text", sty.text__xs34L)}
                >
                  {
                    "\u0627\u0644\u0647\u0647 \u0627\u0645\u06cc\u0631 \u0639\u0628\u0627\u0633\u06cc"
                  }
              ...
              <div className={classNames("all", sty.freeBox__gvOl)}>
                <div
                  className={classNames("all", "__wab_text", sty.text__v3IJc)}
                >
                  {"\u0646\u0627\u0645"}
                </div>
                <div
                  className={classNames("all", "__wab_text", sty.text__bHpdO)}
                >
                  {
                    "\u0627\u0644\u0647\u0647 \u0627\u0645\u06cc\u0631 \u0639\u0628\u0627\u0633\u06cc"
                  }
        ...
        <AntdModal
          ...
          width={"520"}
        >
          <div className={classNames("all", sty.freeBox___5Mvce)}>
            <div className={classNames("all", "__wab_text", sty.text__a6Gy1)}>
              {
                "\u0627\u0632 \u062d\u0630\u0641 \u0642\u0628\u0636 \u0627\u0637\u0645\u06cc\u0646\u0627\u0646 \u062f\u0627\u0631\u06cc\u062f\u061f"
              }
            </div>
          </div>
          <div className={classNames("all", sty.freeBox__dwQz)}>
            <Button
        ...
        <ApiRequest
          ...
          errorDisplay={
            <div className={classNames("all", "__wab_text", sty.text___2Gy0K)}>
              {"Error fetching data"}
            </div>
          }
          loadingDisplay={
            <div className={classNames("all", "__wab_text", sty.text__roRkU)}>
              {"Loading..."}
            </div>
          }
          method={"GET"}
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicIncreaseInInventory__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicIncreaseInInventory__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicIncreaseInInventory__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicIncreaseInInventory__ArgProps,
          internalVariantPropNames: PlasmicIncreaseInInventory__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicIncreaseInInventory__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "chargeStep1") {
    func.displayName = "PlasmicIncreaseInInventory";
  } else {
    func.displayName = `PlasmicIncreaseInInventory.${nodeName}`;
  }
  return func;
}
...
export const PlasmicIncreaseInInventory = Object.assign(
  // Top-level PlasmicIncreaseInInventory renders the root element
  withUsePlasmicAuth(makeNodeComponent("chargeStep1")),
  {
    ...
    // Metadata about props expected for PlasmicIncreaseInInventory
    internalVariantProps: PlasmicIncreaseInInventory__VariantProps,
    internalArgProps: PlasmicIncreaseInInventory__ArgProps,

    pageMetadata: generateDynamicMetadata(wrapQueriesWithLoadingProxy({}), {
      pageRoute: "/Increase-in-inventory",
      pagePath: "/Increase-in-inventory",
      params: {},
      query: {}
    })
  }
...
export default PlasmicIncreaseInInventory;
/* prettier-ignore-end */
