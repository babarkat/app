      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        <div
          ...
          className={classNames(projectcss.all, sty.startIconContainer, {
            ...
            [sty.startIconContainercolor_softGreen]: hasVariant(
              $state,
              "color",
              "softGreen"
            ),
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__ta4Ax)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon3Icon
                className={classNames(projectcss.all, sty.svg__hIu7Y)}
                role={"img"}
              />
            ),
