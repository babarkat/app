  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({
        [sty["pcls_-6hjI1DPNktp"]]: hasVariant(
          globalVariants,
          "screen",
          "mobileOnly"
        ),
        [sty["pcls_1Tz9lSzG0rXG"]]: true,
        [sty["pcls_hBzvWPNbt2U_"]]: hasVariant(
          $state,
          "fullScreen",
          "fullScreen"
        ),
        [sty["pcls_zljQfFjGZXOh"]]:
                ...
                >
                  {hasVariant($state, "fullScreen", "fullScreen") ? (
                    <React.Fragment>
                      {(() => {
                        try {
                          return `موجودی : ${$props.data.toman.amount} تومان `;
                        } catch (e) {
                          if (
                            e instanceof TypeError ||
                            e?.plasmicType === "PlasmicUndefinedDataError"
                          ) {
                            return "\u0627\u0632 \u06a9\u0627\u0631\u062a \u0628\u0627\u0646\u06a9\u06cc \u0628\u0647 \u06a9\u0627\u0631\u062a \u0628\u0627\u0646\u06a9\u06cc \u0628\u0627\u0628\u0631\u06a9\u062a";
                          }
                          throw e;
                        }
                      })()}
                    ...
                    <React.Fragment>
                      {(() => {
                        try {
                          return `موجودی : ${$props.data.toman.amount.toLocaleString()} تومان `;
                        } catch (e) {
                          if (
                            e instanceof TypeError ||
                            e?.plasmicType === "PlasmicUndefinedDataError"
                ...
                $steps["updateType"] = true
                  ? (() => {
                      const actionArgs = {
                        ...
                        operation: 0,
                        value: $props.data.afghani.symbol
                      };
                      return (({
                        variable,
                        value,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__lR26)}>
                ...
                >
                  <React.Fragment>
                    {(() => {
                      try {
                        return $props.data.afghani.name;
                      } catch (e) {
                        if (
                          e instanceof TypeError ||
                          e?.plasmicType === "PlasmicUndefinedDataError"
                ...
                >
                  <React.Fragment>
                    {(() => {
                      try {
                        return `موجودی : ${$props.data.afghani.amount.toLocaleString()} افغانی `;
                      } catch (e) {
                        if (
                          e instanceof TypeError ||
                          e?.plasmicType === "PlasmicUndefinedDataError"
...
const PlasmicDescendants = {
  dialog: ["dialog", "dialogContent", "dialogTitle", "dialogClose"],
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicShopModal__VariantsArgs, ReservedPropsType> &
