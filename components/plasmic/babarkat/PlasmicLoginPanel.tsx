        ...
        className={classNames(
          ...
          sty.root,
          {
            ...
            [sty.rootunnamedVariant_loginByPassword]:
              ...
              hasVariant($state, "loginByPassword", "loginByPassword"),
            [sty.rootunnamedVariant_loginByPassword_password]:
              hasVariant($state, "unnamedVariant", "unnamedVariant") &&
              hasVariant($state, "password", "password") &&
              hasVariant($state, "loginByPassword", "loginByPassword"),
      ...
      >
        <SideEffect
          ...
          className={classNames("__wab_instance", sty.sideEffect, {
            [sty.sideEffectloginByPassword]: hasVariant(
              $state,
              "loginByPassword",
              "loginByPassword"
            )
          ...
          onMount={async () => {
            ...
            $steps["goToPanel"] =
              localStorage.getItem("userbabarcat") != null && $state.token
                ? (() => {
        ...
        <Reveal
          ...
          className={classNames("__wab_instance", sty.reveal, {
            ...
            [sty.revealpassword_unnamedVariant2]:
              hasVariant($state, "unnamedVariant2", "unnamedVariant2") &&
              hasVariant($state, "password", "password"),
            ...
            [sty.revealunnamedVariant_loginByPassword]:
              hasVariant($state, "unnamedVariant", "unnamedVariant") &&
              hasVariant($state, "loginByPassword", "loginByPassword"),
            [sty.revealunnamedVariant_loginByPassword_password_unnamedVariant2]:
              hasVariant($state, "unnamedVariant", "unnamedVariant") &&
              hasVariant($state, "unnamedVariant2", "unnamedVariant2") &&
              hasVariant($state, "password", "password") &&
              hasVariant($state, "loginByPassword", "loginByPassword"),
            [sty.revealunnamedVariant_loginByPassword_unnamedVariant2]:
              hasVariant($state, "unnamedVariant", "unnamedVariant") &&
              hasVariant($state, "unnamedVariant2", "unnamedVariant2") &&
              hasVariant($state, "loginByPassword", "loginByPassword"),
            [sty.revealunnamedVariant_password]:
              hasVariant($state, "unnamedVariant", "unnamedVariant") &&
              hasVariant($state, "password", "password"),
            [sty.revealunnamedVariant_password_unnamedVariant2]:
              hasVariant($state, "unnamedVariant", "unnamedVariant") &&
              hasVariant($state, "unnamedVariant2", "unnamedVariant2") &&
              hasVariant($state, "password", "password"),
            [sty.revealunnamedVariant_unnamedVariant2]:
              hasVariant($state, "unnamedVariant", "unnamedVariant") &&
              hasVariant($state, "unnamedVariant2", "unnamedVariant2")
          })}
          damping={
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Input
                  ...
                  className={classNames("__wab_instance", sty.fragmentInput4, {
              ...
              >
                <Input
                  ...
                  className={classNames("__wab_instance", sty.fragmentInput5, {
              ...
              >
                <Input
                  ...
                  className={classNames("__wab_instance", sty.fragmentInput6, {
              ...
              <Button
                ...
                onClick={async event => {
                  ...
                  if (
                    ...
                    $steps["updateUsername2"] = await $steps["updateUsername2"];
                  }
                          ...
                          customFunction: async () => {
                            return (() => {
                              ...
                              var setCookie = (name, value, days) => {
                                ...
                                document.cookie = `${name}=${value}; expires=${expires}; path=/; domain=app.babarkat.com; secure; SameSite=Lax`;
                              };
                              return setCookie(
                                "token",
                                JSON.stringify(
            ...
            >
              ...
              <Embed
                className={classNames("__wab_instance", sty.embedHtml___2402E)}
                code={"<hr></hr>"}
              />
            </div>
            <Button
