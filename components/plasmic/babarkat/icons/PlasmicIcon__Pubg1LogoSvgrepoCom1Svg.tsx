...
export type Pubg1LogoSvgrepoCom1SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Pubg1LogoSvgrepoCom1SvgIcon(
  props: Pubg1LogoSvgrepoCom1SvgIconProps
) {
...
export default Pubg1LogoSvgrepoCom1SvgIcon;
/* prettier-ignore-end */
