  ...
  return (
    ...
    >
      ...
      <g fill={"currentColor"}>
        <path
          d={
            "M15.75 4a.75.75 0 00-1.5 0v1.052c0 .898 0 1.648.08 2.242.084.628.27 1.195.725 1.65.456.456 1.023.642 1.65.726.461.062 1.015.076 1.658.08l-.831.664a.75.75 0 00.936 1.172l2.5-2a.75.75 0 000-1.172l-2.5-2a.75.75 0 10-.936 1.172l.828.663c-.624-.003-1.087-.016-1.455-.066-.461-.062-.659-.169-.789-.3-.13-.13-.237-.327-.3-.788-.064-.483-.066-1.131-.066-2.095V4z"
          }
        ></path>
