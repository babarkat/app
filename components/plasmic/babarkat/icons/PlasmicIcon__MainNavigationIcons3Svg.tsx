...
export type MainNavigationIcons3SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function MainNavigationIcons3SvgIcon(
  props: MainNavigationIcons3SvgIconProps
) {
...
export default MainNavigationIcons3SvgIcon;
/* prettier-ignore-end */
