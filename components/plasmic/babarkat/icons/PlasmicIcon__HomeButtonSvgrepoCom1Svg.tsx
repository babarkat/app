...
export type HomeButtonSvgrepoCom1SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function HomeButtonSvgrepoCom1SvgIcon(
  props: HomeButtonSvgrepoCom1SvgIconProps
) {
...
export default HomeButtonSvgrepoCom1SvgIcon;
/* prettier-ignore-end */
