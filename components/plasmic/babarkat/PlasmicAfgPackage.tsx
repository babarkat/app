...
import Invoice from "../../Invoice"; // plasmic-import: U_Qsdj6_40KF/component
import Boxselect from "../../Boxselect"; // plasmic-import: zrEzOXBZcn1e/component
import PackItem from "../../PackItem"; // plasmic-import: vbVyLD-uyVh8/component
...
function PlasmicAfgPackage__RenderFunc(props: {
  ...
  const stateSpecs: Parameters<typeof useDollarState>[0] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        type: "private",
        variableType: "text",
        initFunc: ({ $props, $state, $queries, $q, $ctx }) => "Call"
      },
      {
            ...
            try {
              return {
                afghaniWithoutCommission:
                  $state.exchange2.afghaniWithoutCommission,
                tomanWithoutCommission: $state.exchange2.tomanWithoutCommission,
                totalAfghani: $state.exchange2.totalAfghani,
                totalToman: $state.exchange2.totalToman,
                commissionAfghani: $state.exchange2.commissionAfghani,
                commissionToman: $state.exchange2.commissionToman
              };
            } catch (e) {
              if (
                e instanceof TypeError ||
  ...
  return (
    <React.Fragment>
      ...
      >
        <section
          className={classNames("all", sty.section__ihAzx, {
        ...
        >
          <div
            className={classNames("all", sty.freeBox__erD9F, {
          ...
          >
            ...
            >
              ...
              >
                <Icon154Icon
                  className={classNames("all", sty.svg__dAVd1, {
                ...
                >
                  ...
                  <LineXlSvgrepoComSvgIcon
                    className={classNames("all", sty.svg__q9W2Z)}
                    role={"img"}
                  />
                  ...
                  <LineXlSvgrepoComSvgIcon
                    className={classNames("all", sty.svg__ufZm3)}
                    role={"img"}
                  />
                ...
                <div
                  className={classNames("all", sty.freeBox__lp924, {
                ...
                <div
                  className={classNames("all", sty.freeBox__aQf5H, {
                ...
                <Invoice
                  data-plasmic-name={"invoice"}
                  data-plasmic-override={overrides.invoice}
                  className={classNames("__wab_instance", sty.invoice, {
                    [sty.invoicestepscharg_step2]: hasVariant(
                      $state,
                      "stepscharg",
                      "step2"
                    ),
                    [sty.invoicestepscharg_step3]: hasVariant(
                      $state,
                      "stepscharg",
                      "step3"
                    )
                  })}
                  exchange={generateStateValueProp($state, [
                    "invoice",
                    "exchange"
                  ])}
                  number={(() => {
                  ...
                  onExchangeChange={async (...eventArgs: any) => {
                    generateStateOnChangeProp($state, [
                      "invoice",
                      "exchange"
                    ]).apply(null, eventArgs);
                  ...
                  packageAFg={
                    hasVariant($state, "stepscharg", "step3") ? true : undefined
                  }
                  selectpack={(() => {
                    try {
                      return $state.selectPack;
                    } catch (e) {
                      if (
                        e instanceof TypeError ||
                        e?.plasmicType === "PlasmicUndefinedDataError"
              ...
              <div
                className={classNames("all", sty.freeBox__e50W8, {
              ...
              >
                <div
                  className={classNames("all", "__wab_text", sty.text__jLzz7, {
              ...
              {(hasVariant($state, "stepscharg", "step2") ? true : false) ? (
                <div
                  className={classNames("all", sty.freeBox__nYj1B, {
                ...
                >
                    ...
                    {(_par =>
                      ...
                      return (() => {
                        ...
                        return (
                          ...
                          >
                            <div
                              className={classNames("all", sty.freeBox__udtof, {
                  ...
                  <div
                    className={classNames("all", sty.freeBox__uemBq, {
                  ...
                  >
                    {(_par =>
                      ...
                      return (
                        <PackItem
                          data-plasmic-name={"packItem"}
                          data-plasmic-override={overrides.packItem}
                          className={classNames(
                            "__wab_instance",
                            sty.packItem,
                            {
                              [sty.packItemstepscharg_step2]: hasVariant(
                                $state,
                                "stepscharg",
                                "step2"
                              )
                            ...
                            $steps["runCode"] = true
                              ? (() => {
                                  const actionArgs = {
                                    customFunction: async () => {
                                      return (() => {
                                        $state.selectPack = currentItem;
                                        $state.stepscharg = "step3";
                          ...
                          type={(() => {
                            try {
                              return $state.typecharge.toLowerCase();
                            } catch (e) {
                              if (
                                e instanceof TypeError ||
                                e?.plasmicType === "PlasmicUndefinedDataError"
              ...
              {(
                ...
                <div
                  className={classNames("all", sty.freeBox___6ZpW, {
                    ...
                    {(_par =>
                      ...
                      return (() => {
                        ...
                        return (
                          ...
                          >
                            <div
                              className={classNames("all", sty.freeBox__x74Id, {
              ...
              <div
                className={classNames("all", sty.freeBox__fu6GG, {
              ...
              >
                ...
                {(hasVariant($state, "stepscharg", "step3") ? true : false) ? (
                  <div
                    className={classNames("all", sty.freeBox__bEcga, {
                  ...
                  >
                    <Group4SvgIcon
                      className={classNames("all", sty.svg__dTb7B, {
                    ...
                    <div
                      className={classNames("all", sty.freeBox__vXtou, {
            ...
            <section
              className={classNames("all", sty.section__llb2T, {
            ...
            >
              <div
                className={classNames("all", sty.freeBox__zomfH, {
              ...
              >
                ...
                >
                  <div
                    className={classNames("all", "__wab_text", sty.text__cvlh7)}
                  >
                    {"\u0627\u062f\u0627\u0645\u0647"}
                  </div>
                </Button>
            ...
            >
              <div
                className={classNames("all", sty.freeBox__h2BXd, {
              ...
              >
                <div
                  className={classNames("all", "__wab_text", sty.text__cj7Cz, {
                ...
                <div
                  className={classNames("all", "__wab_text", sty.text__rbYEb, {
            ...
            >
              <div
                className={classNames("all", sty.freeBox__y1XiD, {
              ...
              >
                ...
                <div
                  className={classNames("all", "__wab_text", sty.text__f4Ycz, {
                ...
                <div
                  className={classNames("all", sty.freeBox__p0Ma2, {
                ...
                >
                  <div
                    className={classNames("all", "__wab_text", sty.text__azsAw)}
                  >
                    {"\u062a\u0627\u06cc\u06cc\u062f"}
                  </div>
                </Button>
...
export const PlasmicAfgPackage = Object.assign(
  ...
  withUsePlasmicAuth(makeNodeComponent("chargeStep1")),
  {
    ...
    invoice: makeNodeComponent("invoice"),
    ...
    packItem: makeNodeComponent("packItem"),
    ...
    pageMetadata: generateDynamicMetadata(wrapQueriesWithLoadingProxy({}), {
      pageRoute: "/package-AFG",
      pagePath: "/package-AFG",
      params: {},
      query: {}
    })
  }
