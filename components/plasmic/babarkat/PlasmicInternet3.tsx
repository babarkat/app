                ...
                try {
                  return {
                    afghaniWithoutCommission:
                      $state.exchange.afghaniWithoutCommission,
                    tomanWithoutCommission:
                      $state.exchange.tomanWithoutCommission,
                    totalAfghani: $state.exchange.totalAfghani,
                    totalToman: $state.exchange.totalToman,
                    commissionAfghani: $state.exchange.commissionAfghani,
                    commissionToman: $state.exchange.commissionToman
                  };
                } catch (e) {
                  if (
                    e instanceof TypeError ||
                ...
                >
                  ...
                  <Invoice
                    ...
                    className={classNames("__wab_instance", sty.invoice, {
                      [sty.invoicesteps2_step2]: hasVariant(
                        $state,
                        "steps2",
                        "step2"
                      ),
                      [sty.invoicesteps2_step3]: hasVariant(
                        $state,
                        "steps2",
                        "step3"
                      )
                    ...
                    operators2={$state.operators2}
                    operatorselect={$state.operatorselect}
                    selectpack={$state.selectpack}
                    steps2={
                      hasVariant($state, "steps2", "step3") &&
                      hasVariant(globalVariants, "screen", "mobileOnly")
                        ? "step3"
                      ...
                      return (() => {
                        const child$Props = {
                          className: classNames(
                            ...
                            sty.boxselect,
                            {
                              [sty.boxselectsteps2_step3]: hasVariant(
                                $state,
                                "steps2",
                                "step3"
                              )
                                        ...
                                        return (
                                          <PackItem
                                            ...
                                            className={classNames(
                                              ...
                                              sty.packItem,
                                              {
                                                [sty.packItemsteps2_step2]:
                                                  hasVariant(
                                                    $state,
                                                    "steps2",
                                                    "step2"
                                                  ),
                                                [sty.packItemsteps2_step3]:
                                                  hasVariant(
                                                    $state,
                                                    "steps2",
                                                    "step3"
                ...
                >
                  <div
                    ...
                    onClick={async event => {
                      ...
                      $steps["updateOperators22"] = true
                        ...
                        : undefined;
                      if (
                        $steps["updateOperators22"] != null &&
                        typeof $steps["updateOperators22"] === "object" &&
                        typeof $steps["updateOperators22"].then === "function"
                      ) {
                        $steps["updateOperators22"] =
                          await $steps["updateOperators22"];
                      }
                    }}
                  />
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox__tOVwG, {
                      ...
                      [sty.freeBoxsteps2_step3__tOVwGYl49R]: hasVariant(
                        $state,
                        "steps2",
                        "step3"
                      )
                      ...
                      <div
                        className={classNames(
                          ...
                          hasVariant($state, "steps2", "step3")
                            ...
                            : undefined,
                          {
                            [sty.textsteps2_step3__iwv10Yl49R]: hasVariant(
                              $state,
                              "steps2",
                              "step3"
                            )
              ...
              try {
                return {
                  data: [
                    ...
                    {
                      text: "توضیحات",
                      value: `بسته${$state.operators2[$state.operatorselect].description} - ${$state.selectpack.name}`
                    },
                    {
                      text: "تاریخ و زمان",
                      value: (() => {
...
const PlasmicDescendants = {
  ...
  button: ["button"],
  tabContent: ["tabContent", "packItem"],
  packItem: ["packItem"],
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicInternet3__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicInternet3__ArgsType, ReservedPropsType> &
